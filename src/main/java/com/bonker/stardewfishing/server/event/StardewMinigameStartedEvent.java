...
public class StardewMinigameStartedEvent extends StardewMinigameEvent {
    ...
    public StardewMinigameStartedEvent(ServerPlayer player, FishingHook hook, ItemStack fishingRod,
        ...
        this.lineStrength = player.getAttributeValue(SFAttributes.LINE_STRENGTH.get());
        this.barSize = (int) player.getAttributeValue(SFAttributes.BAR_SIZE.get());
        this.treasureChanceBonus = player.getAttributeValue(SFAttributes.TREASURE_CHANCE_BONUS.get());
        this.goldenChestBonus = player.getAttributeValue(SFAttributes.GOLDEN_CHEST_BONUS.get());
        this.expMultiplier = player.getAttributeValue(SFAttributes.EXP_MULTIPLIER.get());
